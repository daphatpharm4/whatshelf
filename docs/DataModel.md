...
```json
{
  "id": "m_001", "merchantId": "m_001",
  "displayName": "Dorcas Styles", "phone": "+2547...",
...
```json
{
  "id": "p_001", "merchantId": "m_001",
  "title": "Midi Dress", "price": 2400,
...
```json
{
  "id": "o_001", "merchantId": "m_001", "orderNo": "202511-0001",
  "status": "PAID",
  "buyer": {"phone": "+2547...", "name": "Anne"},
  "items": [{"productId": "p_001", "qty": 2, "unitPrice": 2400}],
  "totals": {"subTotal": 4800, "tax": 0, "grandTotal": 4800},
...
```json
{
  "id": "pay_001", "merchantId": "m_001",
  "orderId": "o_001", "provider": "MPESA",
  "intentId": "pi_001", "amount": 4800,
  "status": "SUCCESS", "direction": "C2B",
...
```json
{
  "id": "r_001", "merchantId": "m_001",
  "orderId": "o_001",
  "pdfUrl": "https://blob/receipts/r_001.pdf",
  "sentVia": ["WHATSAPP"], "sentAt": ["2025-11-02T13:05:24Z"]
}
```
...
```json
{
  "id": "e_001", "merchantId": "m_001",
  "type": "PAYMENT_RECEIVED",
  "actor": "SYSTEM", "correlationId": "o_001",
